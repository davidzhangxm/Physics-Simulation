...
public:
  ...
  AABB(const glm::vec3& center, float_t radius);
  ...
  void extend(const glm::vec3& center, float_t radius);
 ...
 float_t getLongestEdge() const;

  /// Retrieves the shortest edge.
  /// If the AABB is NULL, then 0 is returned.
  float_t getShortestEdge() const;
